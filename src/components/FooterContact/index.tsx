      ...
      <div className="container p-4">
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 mb-4 mb-md-0">
            <h5 className="text-uppercase" style={{color: "white"}}>Redes</h5>
          ...
          <div className="col-lg-4 col-md-12 mb-4 mb-md-0 text-white">
            ...
            <p style={{color: "white"}}>
              Aimob é uma plataforma dedicada a ajudar você a encontrar o imóvel dos seus sonhos. 
              Com uma vasta seleção de imóveis à venda, garantimos que você encontrará o lar perfeito.
            </p>
          </div>
        </div>
      </div>
